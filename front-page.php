            ...
            <div class="entry-wrap">
                        ...
                        <?php while ($the_query -> have_posts()) : $the_query -> the_post(); ?>
                            <div class="featuredhomepost">
                                <a href="<?php the_permalink(); ?>">
                                    <img class="ponygirl" src="http://184.175.101.117/~kruzinusa/wp-content/uploads/2017/08/Pony_Girl_final_revised1.jpg" alt="">
                                    <h6><?php the_title(); ?></h6>
                                    <p><?php echo get_excerpt(); ?><a href="<?php the_permalink(); ?>"><b>Read More</b></a></p>
                ...
                <div class="x-column x-1-2">
                    <div class="homefeatured">
                        <div class="x-column x-1-2">
                            <h1 class="hometitle">Builders Showrooms</h1>
                            <div class="whitebg">
